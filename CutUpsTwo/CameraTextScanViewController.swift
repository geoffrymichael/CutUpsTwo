...
class CameraTextScanViewController: UIViewController {
...
extension CameraTextScanViewController: VNDocumentCameraViewControllerDelegate {
...
//        activityIndicator.isHidden = false
        ...
        textRecognitionWorkQueue.async {
            ...
            DispatchQueue.main.async(execute: {
                ...
                self.text = self.resultingText
                
                vc.lyricTextView.text = self.text
